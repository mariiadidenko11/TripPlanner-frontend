export const INITIAL_DATA = {
    ...
    data_lock: [
        { id: 'd1', email: 'example11@gmail.com', hash: '123456', created_at: '2026-01-01T00:00:00Z' }
    ],
    ...
    trips: [
        {
            ...
            status: 'active', rate: 10, start_money: 8500, fact_money: 6340,
        ...
        },
        {
            ...
            status: 'completed', rate: 10, start_money: 3500, fact_money: 3180,
        ...
        },
        {
            ...
            status: 'completed', rate: 8, start_money: 2500, fact_money: 2650,
        ...
        },
        {
            ...
            status: 'active', rate: 8, start_money: 6000, fact_money: 4800,
        ...
        },
        {
            ...
            status: 'completed', rate: 10, start_money: 5500, fact_money: 5200,
        ...
        },
        {
            ...
            status: 'completed', rate: 8, start_money: 1800, fact_money: 1650,
        ...
        },
        {
            ...
            status: 'completed', rate: 10, start_money: 2200, fact_money: 1980,
        ...
        },
        {
            ...
            status: 'completed', rate: 10, start_money: 3800, fact_money: 3540,
        ...
        },
        {
            ...
            status: 'active', rate: 10, start_money: 3200, fact_money: 2100,
    ...
    tasks: {
        ...
        't5': [
            ...
            { id: 'tk5_5', trips_id: 't5', value: 'Побачити Акіхабару ввечері', check: true, note: 'Неон та аніме после 20:00.', created_at: '2025-09-05T00:00:00Z' },
    ...
    notes: {
        ...
        't4': [
            { id: 'n4_1', trips_id: 't4', value: 'Лайфхаки Рим\nКолізей + Форум = єдикий квиток через Coopculture (без черги). Пантеон — безкоштовно, але черга. Гелато: Fatamorgana > решти.', check: false, created_at: '2026-01-10T00:00:00Z' },
