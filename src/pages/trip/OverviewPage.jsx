...
export default function OverviewPage() {
    ...
    const saveEdit = async () => {
        setEditSaving(true);
        try {
            // Один запит на backend (PUT /api/trips/edit) — і деталі, і опис разом
    ...
    return (
        <div className="ov-grid">
            ...
            <div className="ov-card ov-card--full ov-card--details">
                ...
                {!editing ? (
                    ...
                    <>
                        ...
                        {/* Опис подорожі — у тій самій картці */}
                        <div className="ov-desc-section">
                            <div className="ov-desc-heading">📝 Опис подорожі</div>
                    ...
                    <>
                        ...
                        {/* Опис подорожі — редагується в тому ж режимі */}
                        <div className="ov-desc-edit">
                            <div className="ov-desc-heading">📝 Опис подорожі</div>
                            <textarea
