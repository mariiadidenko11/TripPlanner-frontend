    ...
    return (
        <div className="container page sp-page">
            ...
            <div className="sp-header">
                <div>
                    <p className="sp-eyebrow">Travel Analytics</p>
                ...
                <table className="sp-table">
                    ...
                    <tbody>
                        {filtered.length === 0 ? (
                            ...
                            const statusLbl = { active: 'Активна', completed: 'Завершена', waiting: 'Очікує' };
                            return (
                                <tr key={t.id || i} className="sp-table__row">
                                    ...
                                    <td>
                                        {t.rate > 0
                                            ? <span className="sp-stars">{'★'.repeat(t.rate)}</span>
            ...
            <style>{`
                ...
                .sp-eyebrow { font-size:10px; font-weight:700; letter-spacing:0.14em; text-transform:uppercase; color:#40B3E0; margin-bottom:6px; }
                ...
                .sp-stars { color:#f59e0b; font-size:12px; letter-spacing:1px; }
