...
export default function AddTripPage() {
    ...
    const inputProps = (field, extraProps = {}) => ({
        value: form[field],
    ...
    return (
        <div className="atp-page">
                    ...
                    <div className="atp-field">
                        ...
                        <div className="atp-input-prefix-wrap">
                            ...
                            <input
                                ...
                                min="0"
                                placeholder="0"
                                {...inputProps('start_money', { className: `atp-input atp-input--prefixed ${focused === 'start_money' ? 'atp-input--focused' : ''} ${form.start_money ? 'atp-input--filled' : ''}` })}
                            />
                        </div>
                    </div>
            ...
            <style>{`
                ...
                .atp-btn--submit:active:not(:disabled) {
                    transform: translateY(0);
                }
                .atp-btn--submit:disabled {
                    opacity: 0.75;
                    cursor: not-allowed;
                }
                .atp-btn--loading {
                ...
                .atp-btn--submit:hover .atp-btn__arrow {
